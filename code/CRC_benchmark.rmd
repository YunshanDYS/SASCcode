...
# Please change it to your own path to the data  
  if (file.exists(paste0(data_dir, "/CRC_final_annotation.rds"))){
    real_data <- readRDS(paste0(data_dir, "/CRC_final_annotation.rds"))
  } else {
    cat("***Please first run ''preprocessing_CRC.Rmd'' for data preprocessing***")
  }
...
# plot the clustering results    
  ...
  ggsave(filename = paste0(output_figure_dir, "/zinbwave_CD4.pdf"), width = 4, height = 3.5)
  print(p)
```
...
# plot the clustering results    
  ...
  ggsave(filename = paste0(output_figure_dir, "/zinbwave_CD8.pdf"), width = 4, height = 3.5)
  print(p)
```
...
# Plot the bar plot
  ...
  ggsave(filename = paste0(output_figure_dir, "/zinbwave_typenum.pdf"), width = 7, height = 3.5)
  print(p)
```
...
# cell_annot is the cell annotations (the ones corresponding to the cluster assigned to)
  ...
  ggsave(filename = paste0(output_figure_dir, "/zinbwave_weights.pdf"), width = 6, height = 5)
  print(p)
```
